...
sql = """
        SELECT 
           ...
           IF(@prev_exports_volume = `tabCustomer`.`custom_volume_of__exports`, '', `tabCustomer`.`custom_volume_of__exports`) AS `total_amount`,
           @prev_exports_volume := `tabCustomer`.`custom_volume_of__exports`,
