columns = [
    {"label": _("Tax ID"), "fieldname": "tax_id", "fieldtype": "Data", "width": 100},
    {"label": _("Customer Name"), "fieldname": "customer_name", "fieldtype": "Data", "width": 170},
    {"label": _("Name1"), "fieldname": "name1", "fieldtype": "Data", "width": 150},
    {"label": _("Custom Company Code"), "fieldname": "custom_company_code", "fieldtype": "Data", "width": 100},
    {"label": _("Season"), "fieldname": "season", "fieldtype": "Data", "width": 100},
    {"label": _("Season Name"), "fieldname": "season__name", "fieldtype": "Data", "width": 100},
    ...
    {"label": _("Price"), "fieldname": "price", "fieldtype": "Currency", "width": 150},
    {"label": _("Is Member"), "fieldname": "is_member", "fieldtype": "Data", "width": 100}  # New column for membership check
]
